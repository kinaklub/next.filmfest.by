# -*- coding: utf-8 -*-
# Generated by Django 1.9.8 on 2016-08-14 03:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_be', models.CharField(max_length=250)),
                ('name_ru', models.CharField(max_length=250)),
                ('link', models.CharField(blank=True, default='', max_length=250)),  # noqa
                ('image', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='wagtailimages.Image')),  # noqa
            ],
        ),
    ]
